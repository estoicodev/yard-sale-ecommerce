  ...
  return (
    <section className="w-full max-w-sm h-full mx-auto flex flex-col py-10 relative login">
      ...
      <form onSubmit={handleSubmit} className="w-full flex flex-col login__form">
        ...
        <input onChange={(e) => setName(e.target.value)} className="h-11 sm:h-12 mb-5 px-4 text-[#a3a3a3] bg-[#f7f7f7] rounded-lg border-none text-base font-normal outline-0 outline-transparent focus:outline-1 focus:outline-offset-1 focus:outline-[#c7c7c7] hover:bg-opacity-80 value" required/>
        <label htmlFor="email" className="mb-4 text-base font-bold login__label">Email address</label>
        <input onChange={(e) => setEmail(e.target.value)} className="h-11 sm:h-12 mb-5 px-4 text-[#a3a3a3] bg-[#f7f7f7] rounded-lg border-none text-base font-normal outline-0 outline-transparent focus:outline-1 focus:outline-offset-1 focus:outline-[#c7c7c7] hover:bg-opacity-80 value" required/>
        <label htmlFor="password" className="mb-4 text-base font-bold login__label">Password</label>
        <input onChange={(e) => setPassword(e.target.value)} className="h-11 sm:h-12 mb-11 px-4 text-[#a3a3a3] bg-[#f7f7f7] rounded-lg border-none text-base font-normal outline-0 outline-transparent focus:outline-1 focus:outline-offset-1 focus:outline-[#c7c7c7] hover:bg-opacity-80 value" required/>
